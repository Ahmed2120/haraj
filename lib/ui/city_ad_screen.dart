...
class CityAdScreen extends StatefulWidget {
  String city;
  int city_id;
  CityAdScreen({Key key, this.city, this.city_id}) : super(key: key);
  @override
  _CityAdScreenState createState() => _CityAdScreenState();
}

class _CityAdScreenState extends State<CityAdScreen>
  ...
  _getAllAds() async {
    var res = await Api().getData(
        '${ApiConfig.adsFilterPath}?${ApiConfig.cityIdQueryParmKey}=${widget.city_id}');
